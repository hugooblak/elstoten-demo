...
function npl_choices() {
	return apply_filters(
		...
		array(
			'service'  => array(
				'replacement' => __( 'Lägga om hela taket', 'elstoten-leads' ),
				'storm'       => __( 'Storm or hail damage', 'elstoten-leads' ),
				'repair'      => __( 'Läcka eller reparation', 'elstoten-leads' ),
				'inspection'  => __( 'Bara en besiktning', 'elstoten-leads' ),
				'not-sure'    => __( 'Vet inte än', 'elstoten-leads' ),
			),
			'timeline' => array(
				'asap'     => __( 'Så snart som möjligt', 'elstoten-leads' ),
				'1-3'      => __( 'Inom 1–3 månader', 'elstoten-leads' ),
				'research' => __( 'Jag kollar bara priser', 'elstoten-leads' ),
			),
		)
	);
}
...
function npl_consent_text() {
	return apply_filters(
		'npl_consent_text',
		__( 'Genom att skicka förfrågan godkänner du att vi kontaktar dig om ditt tak. Vi sparar uppgifterna bara för det, lämnar dem aldrig vidare, och du kan när som helst be oss radera dem.', 'elstoten-leads' )
	);
}
...
function npl_statuses() {
	return array(
		'new'       => __( 'New', 'elstoten-leads' ),
		'contacted' => __( 'Kontaktad', 'elstoten-leads' ),
		'quoted'    => __( 'Quote sent', 'elstoten-leads' ),
		'won'       => __( 'Won', 'elstoten-leads' ),
		'lost'      => __( 'Lost', 'elstoten-leads' ),
		'spam'      => __( 'Misstänkt spam', 'elstoten-leads' ),
	);
}
